...
public class SaveMechanism: MonoBehaviour
{
    ...
    public Button addSuctionButton;
    ...
    public void LoadGame()
    {
        ...
        if (File.Exists(Application.persistentDataPath + "/gamesave.save"))
        {
            ...
            {
                if (save.RobotCmds[i].Contains("True") || save.RobotCmds[i].Contains("False") || save.RobotCmds[i].Contains("true") || save.RobotCmds[i].Contains("false"))
                {
                    addSuctionButton.onClick.Invoke();
                    ...
                    */
                    ...
                    var lo = codeLines[codeLines.Count - 1].GetComponent<LineOperations>();
