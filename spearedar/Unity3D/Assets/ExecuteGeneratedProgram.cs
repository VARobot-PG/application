...
public class ExecuteGeneratedProgram : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        codeToCanvasGenerator.programCodeFormatted.text = codeToCanvasGenerator.programCodeUnformatted.text;
        string[] k = codeToCanvasGenerator.programCodeFormatted.text.Split('\n');
        ...
        codeToCanvasGenerator.programCodeFormatted.text = formattedCode;
    }
