#ifndef _ROS_SERVICE_SetPTPWithLCmd_h
#define _ROS_SERVICE_SetPTPWithLCmd_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
...
static const char SETPTPWITHLCMD[] = "dobot_msgs/SetPTPWithLCmd";

  class SetPTPWithLCmdRequest : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return SETPTPWITHLCMD; };
    const char * getMD5(){ return "a10e8548c4075cc065a198a2c400bff5"; };

  };

  class SetPTPWithLCmdResponse : public ros::Msg
  {
    public:
  ...
  class SetPTPWithLCmd {
    public:
    typedef SetPTPWithLCmdRequest Request;
    typedef SetPTPWithLCmdResponse Response;
  };
